...
if ( ! class_exists( 'LicenseUpdated' ) ) :
	...
	class LicenseUpdated {
		 ...
		 * @var string
		 */
		public $trigger = 'edd_license_updated';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'License Updated', 'suretriggers' ),
				'action'        => $this->trigger,
		...
		public function trigger_listener( $license_id, $status ) {
			...
			$context['updated_status'] = $status;
			$context['download_id']    = $context['download_id'];
			$context['updated_at']     = current_time( 'mysql' );
