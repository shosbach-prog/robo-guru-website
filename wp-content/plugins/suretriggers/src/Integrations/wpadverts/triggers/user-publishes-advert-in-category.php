<?php
/**
 * UserPublishesAdvertInCategory.
 * php version 5.6
 *
 * @category UserPublishesAdvertInCategory
...
if ( ! class_exists( 'UserPublishesAdvertInCategory' ) ) :
	 ...
	 */
	class UserPublishesAdvertInCategory {
		 ...
		 * @var string
		 */
		public $trigger = 'wpadverts_user_publishes_advert_in_category';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'User publishes an advert in a category', 'suretriggers' ),
				'action'        => $this->trigger,
	 ...
	 */
	UserPublishesAdvertInCategory::get_instance();
