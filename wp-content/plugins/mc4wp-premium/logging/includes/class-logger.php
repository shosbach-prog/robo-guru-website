...
class MC4WP_Logger
{
     ...
     */
    public function log_top_bar_request($list_id, $email_address, $merge_vars, ?MC4WP_MailChimp_Subscriber $subscriber_data = null): void
    {
        $data = [
            'list_id' => $list_id,
            'type' => 'mc4wp-top-bar',
     ...
     */
    public function log_integration_request(MC4WP_Integration $integration, $email, $merge_vars, $data_map = [], $related_object_id = 0): void
    {
     ...
     */
    public function log_form_request(MC4WP_Form $form, $email_address, array $merge_vars, array $data_map = []): void
    {
        $data = [
            'type' => 'mc4wp-form',
     ...
     * @param $data
     */
    private function log_request($data): void
    {
