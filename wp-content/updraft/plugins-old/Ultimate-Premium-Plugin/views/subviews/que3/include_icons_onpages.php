<ul class="sfsiplus_icn_listing8 sfsi_plus_closerli sfsi_exclude_ul <?php echo $_inclusionSectionClass; ?>">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on homepage', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on other internal pages (not homepage, ...)', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on single posts pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on tag pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on category pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on date based archives pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on author archives pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on search results pages', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
	</li>
    ...
    <li class="">
		...
		<div class="sfsiplus_right_info">
			<p>
				<span class="sfsiplus_toglepstpgspn">
                	<?php  _e( 'Show icons on URLs which contain at least one of the following strings:', 'ultimate-social-media-plus' ); ?>
                </span>
            </p>
		</div>
				...
				if(isset($option8['sfsi_plus_include_urlKeywords']) && !empty($option8['sfsi_plus_include_urlKeywords']) && is_array($option8['sfsi_plus_include_urlKeywords']))
				{
					...
					for($i = 0; $i < $count; $i++)
					{
						...
						echo '<fieldset>
							...
							<a href="javascript:" class="sfsi_plus_include_deleteKeywordField">'.__( 'Delete', 'ultimate-social-media-plus' ).'</a>
						</fieldset>';
					}
				}
				else
