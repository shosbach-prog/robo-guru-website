...
function cmplz_field_notices( ): array {
	...
	if ( 'clarity' === cmplz_get_option( 'compile_statistics' ) ) {
		$notices[] = [
			...
			'url' => 'https://complianz.io/microsoft-consent-mode/?utm_source=statistics-configuration&utm_medium=plugin&utm_campaign=articles&utm_id=66&utm_content=clarity_consent_mode'
		];
	}
