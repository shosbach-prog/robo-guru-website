...
if ( ! class_exists( 'AffiliateCreated' ) ) :
	...
	class AffiliateCreated {
		 ...
		 * @var string
		 */
		public $trigger = 'fluentaffiliate_affiliate_created';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				...
				'action'        => $this->trigger,
				'common_action' => 'fluent_affiliate/affiliate_created',
