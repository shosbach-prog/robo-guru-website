...
$questions = array(
	...
	[
		...
		'react_conditions'        => [
			'relation' => 'AND',
			[
				'data-from-whom-au' => '11',
			]
		],
	],
	[
		'id'       => 'what-kind-of-data-au',
		'type' => 'multicheckbox',
		'default' => '',
		'required' => true,
	...
	[
		'id'       => 'security-protocol-where-url-au',
		'type' => 'url',
		'default' => '',
	...
	[
		'id'       => 'processing-security-measures-au',
		'type' => 'multicheckbox',
		'default' => '',
	...
	[
		'id'       => 'processing-security-measures-other-au',
		'type' => 'textarea',
		'default' => '',
		...
		'react_conditions'        => [
			'relation' => 'AND',
			[
				'processing-security-measures-au' => '17',
			]
		],
	],
	[
