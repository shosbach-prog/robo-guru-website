...
class MC4WP_Ecommerce_Product_Observer extends MC4WP_Ecommerce_Object_Observer
{
    ...
    {
        // update products
        add_action('woocommerce_new_product', [$this, 'on_product_save']);
        add_action('save_post_product', [ $this, 'on_product_save' ]);

        // delete products & orders when they're deleted in WP
        add_action('delete_post', [ $this, 'on_post_delete']);

        // update promo code
        add_action('save_post_shop_coupon', [ $this, 'on_coupon_update' ]);
    }
