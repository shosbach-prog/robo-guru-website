...
class MC4WP_Ecommerce
{
    ...
    {
        $send_to_mailchimp = true;
        /**
         * Determine if a customer get sent to mailchimp.
         *
         * @param bool $send_to_mailchimp
         * @param WP_User|WC_Order|object $customer_data
         *
         * @return bool on true it will be sent to Mailchimp on false not.
         */
        $send_to_mailchimp = apply_filters('mc4wp_ecommerce_send_customer_to_mailchimp', $send_to_mailchimp, $customer_data);
        if (! $send_to_mailchimp) {
            return '';
        }
    ...
    public function update_store(array $data)
    {
        ...
        try {
            ...
            if ($e->getCode() == 400 && $e->detail && stripos($e->detail, "list may not be changed") >= 0) {
