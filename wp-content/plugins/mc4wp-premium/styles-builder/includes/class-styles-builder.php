...
class MC4WP_Styles_Builder
{
    ...
    {
        $all_styles = (array) get_option('mc4wp_form_styles', []);
    ...
    protected function get_css_string($form_id)
    {
        ...
        $form_styles = isset($this->styles[ 'form-' . $form_id ]) ? $this->styles[ 'form-' . $form_id ] : [];
     ...
     * @return array
     */
    public function get_stylesheet_files(array $form_ids = [])
    {
        $dir = $this->get_stylesheets_dir();
