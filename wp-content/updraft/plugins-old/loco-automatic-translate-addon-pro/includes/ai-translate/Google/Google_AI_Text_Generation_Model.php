<?php
/**
 * Class Loco_Automatic_Translate_Addon_Pro\AI_Translate\Google\Google_AI_Text_Generation_Model
 *
 * @since 0.1.0
 * @package ai-services
 */
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Google\Types\Safety_Setting;
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\API\Types\Parts\Function_Call_Part;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\API\Types\Parts\Function_Response_Part;
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\API\Types\Tools\Function_Declarations_Tool;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\API\Types\Tools\Web_Search_Tool;
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Contracts\With_Web_Search;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Exception\Generative_AI_Exception;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Traits\Model_Param_System_Instruction_Trait;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Traits\Model_Param_Text_Generation_Config_Trait;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Traits\Model_Param_Tool_Config_Trait;
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Traits\Model_Param_Tools_Trait;
