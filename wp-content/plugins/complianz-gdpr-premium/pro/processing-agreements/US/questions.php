...
$questions = array(
	...
	[
		'id'       => 'security-protocol-where-url-us',
		'type' => 'url',
		'default' => '',
	...
	[
		'id'       => 'processing-security-measures-us',
		'type' => 'multicheckbox',
		'default' => '',
	...
	[
		'id'       => 'processing-security-measures-other-us',
		'type' => 'textarea',
		'default' => '',
		...
		'react_conditions'        => [
			'relation' => 'AND',
			[
				'processing-security-measures-us' => '17',
			]
		],
	],
        // RIGHT OF AUDIT
