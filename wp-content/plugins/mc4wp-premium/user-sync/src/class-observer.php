...
class Observer
{
    ...
    {
        // don't act if fired with user ID 0
        // the Rank Math plugin does this for some reason
        if ((int) $user_id === 0) {
            return;
        }
    ...
    public function on_updated_user_meta($meta_id, $user_id, $meta_key, $meta_value): void
    {
    ...
    private function maybe_schedule($user_id): void
    {
