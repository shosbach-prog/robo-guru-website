...
class MC4WP_Form_Widget_Enhancements
{
    ...
    {
        add_filter('mc4wp_form_widget_sanitize_settings', [ $this, 'sanitize_widget_settings' ], 10, 1);
        add_action('mc4wp_form_widget_form', [ $this, 'widget_form' ], 10, 2);
    }
     ...
     * @return mixed
     */
    public function sanitize_widget_settings($new_settings)
    {
