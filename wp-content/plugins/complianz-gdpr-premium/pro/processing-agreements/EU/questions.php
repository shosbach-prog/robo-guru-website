...
$questions = array(
        ...
        [
	        ...
	        'react_conditions'        => [
		        'relation' => 'AND',
		        [
			        'what-kind-of-data' => '13',
		        ]
	        ],
        ],
		[
			'id'       => 'name_of_processor',
			'type' => 'hidden',
			'default' => '',
        ...
        [
	        'id'       => 'security-protocol-where-url',
	        'type' => 'url',
            'default' => '',
        ...
        [
	        'id'       => 'processing-security-measures',
	        'type' => 'multicheckbox',
            'default' => '',
        ...
        [
	        'id'       => 'processing-security-measures-other',
	        'type' => 'textarea',
            'default' => '',
            ...
            'react_conditions'        => [
	            'relation' => 'AND',
	            [
		            'processing-security-measures' => '17',
	            ]
            ],
        ],
        // RIGHT OF AUDIT
