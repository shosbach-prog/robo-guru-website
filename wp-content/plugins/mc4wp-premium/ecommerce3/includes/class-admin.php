...
class MC4WP_Ecommerce_Admin
{
    ...
    public function add_hooks()
    {
        ...
        add_action('load-mc4wp_page_mailchimp-for-wp-ecommerce', [$this, 'action_load_page'], 10, 0);
    ...
    public function action_load_page()
    {
        if (! mc4wp_has_active_license()) {
            mc4wp('admin.messages')->flash('You need to activate your MC4WP Premium license in order to access the E-Commerce settings page.', 'notice');
