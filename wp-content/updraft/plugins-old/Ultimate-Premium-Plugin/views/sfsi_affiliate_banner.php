...
<div id="accordion2">
    ...
    <div class="tab11">
        <a target="_blank" href="https://goo.gl/6w2Rg5">
        	<img src="<?php echo SFSI_PLUS_PLUGURL ?>images/affiliate_banner.png" alt="<?php _e( 'Affiliate Banner', 'ultimate-social-media-plus' ); ?>" />
        </a>
    </div>
</div>