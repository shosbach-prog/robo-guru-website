...
if ( ! class_exists( 'EDDOrderCreated' ) ) :
	...
	class EDDOrderCreated {
		 ...
		 * @var string
		 */
		public $trigger = 'edd_order_created';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Order Created for Specific Download', 'suretriggers' ),
				'action'        => $this->trigger,
