	...
	class SubscriptionActivated {
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				...
				'action'        => $this->trigger,
				'common_action' => [ 'fluent_cart/subscription_activated' ],
		 ...
		 *  Trigger listener
		 *
		 * @param array $data Data from FluentCart subscription activation containing subscription, order, customer, meta.
		 *
		 * @return void
		 */
