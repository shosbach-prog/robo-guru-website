...
if ( ! class_exists( 'UserPaysAdvert' ) ) :
	...
	class UserPaysAdvert {
		 ...
		 * @var string
		 */
		public $trigger = 'wpadverts_user_pays_advert';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'User pays an advert', 'suretriggers' ),
				'action'        => $this->trigger,
