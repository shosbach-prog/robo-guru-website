<?php
/**
 * Class Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\API\Types\Tool_Config
 *
 * @since 0.5.0
 * @package ai-services
 */
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Util\Strings;
