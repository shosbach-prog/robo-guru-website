<?php
/**
 * UserPublishesPaidAdvert.
 * php version 5.6
 *
 * @category UserPublishesPaidAdvert
...
if ( ! class_exists( 'UserPublishesPaidAdvert' ) ) :
	...
	class UserPublishesPaidAdvert {
		 ...
		 * @var string
		 */
		public $trigger = 'wpadverts_user_publishes_paid_advert';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'User publishes a paid advert', 'suretriggers' ),
				'action'        => $this->trigger,
		...
		public function trigger_listener( $payment ) {
			...
			if ( 'adverts-pricing' !== $payment_type ) {
				return;
			}
	 ...
	 */
	UserPublishesPaidAdvert::get_instance();
