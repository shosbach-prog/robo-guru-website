...
if (!defined('RF_PRO_VER')) {
    define('RF_PRO_VER', '4.8.18.16');
}
...
<div class="rf-spinner" aria-hidden="true" hidden></div>">' . esc_textarea($val) . '</textarea>';
    ...
    public function field_target_email()
    {
        $settings = $this->get_settings();
        ?>
        <input type="email" name="<?php echo esc_attr($this->settings_option); ?>[target_email]"
            value="<?php echo esc_attr($settings['target_email']); ?>" class="regular-text" />
        <p class="description">
    ...
    public function field_contact_shortcode()
    {
        $settings = $this->get_settings();
        ?>
        <input type="text" name="<?php echo esc_attr($this->settings_option); ?>[contact_shortcode]"
            value="<?php echo esc_attr($settings['contact_shortcode']); ?>" class="regular-text"
            placeholder="[contact-form-7 id=&quot;123&quot; title=&quot;Kontakt&quot;]" />
        <p class="description">
    ...
    public function field_contact_button_text()
    {
        $settings = $this->get_settings();
        ?>
        <input type="text" name="<?php echo esc_attr($this->settings_option); ?>[contact_button_text]"
            value="<?php echo esc_attr($settings['contact_button_text']); ?>" class="regular-text" />
        <?php
    }
    ...
    public function field_forum_widget_mode()
    {
        ...
        <select name="<?php echo esc_attr($this->settings_option); ?>[forum_widget_mode]">
            <option value="floating" <?php selected($mode, 'floating'); ?>>
                <?php esc_html_e('Rechts schwebend (Desktop)', 'robo-finder-pro'); ?>
            </option>
            <option value="inline_top" <?php selected($mode, 'inline_top'); ?>>
                <?php esc_html_e('Inline oben im Topic', 'robo-finder-pro'); ?>
            </option>
            <option value="inline_after_first_post" <?php selected($mode, 'inline_after_first_post'); ?>>
                <?php esc_html_e('Inline unter dem ersten Beitrag (empfohlen)', 'robo-finder-pro'); ?>
            </option>
            <option value="inline_bottom" <?php selected($mode, 'inline_bottom'); ?>>
                <?php esc_html_e('Inline unten im Topic', 'robo-finder-pro'); ?>
            </option>
        </select>
        <?php
    }
    ...
    public function field_robots_archive_meta_title()
    {
        $settings = $this->get_settings();
        ?>
        <input type="text" name="<?php echo esc_attr($this->settings_option); ?>[robots_archive_meta_title]"
            value="<?php echo esc_attr($settings['robots_archive_meta_title']); ?>" class="regular-text"
            placeholder="Roboter im Vergleich – Robo-Guru" />
        <p class="description">
            <?php esc_html_e('Überschreibt den Title auf dem CPT-Archiv /roboter/. Leer lassen = Standard von Theme/SEO-Plugin.', 'robo-finder-pro'); ?>
        </p>
        <?php
    }
    ...
    public function field_robots_archive_meta_description()
    {
        $settings = $this->get_settings();
        ?>
        <textarea name="<?php echo esc_attr($this->settings_option); ?>[robots_archive_meta_description]" rows="3"
            class="large-text"
            placeholder="Vergleiche Reinigungs-, Service- und Transportroboter für Profis – mit klaren Empfehlungen, ROI-Check und Praxis-Tipps."><?php echo esc_textarea($settings['robots_archive_meta_description']); ?></textarea>
        <p class="description">
            <?php esc_html_e('Meta-Description für /roboter/. Bei Rank Math wird sie über Filter gesetzt, ohne SEO-Plugin als Fallback im Head ausgegeben.', 'robo-finder-pro'); ?>
        </p>
        <?php
    }
    ...
    public function field_finder_meta_title()
    {
        $settings = $this->get_settings();
        ?>
        <input type="text" name="<?php echo esc_attr($this->settings_option); ?>[finder_meta_title]"
            value="<?php echo esc_attr($settings['finder_meta_title']); ?>" class="regular-text"
            placeholder="Robo Finder – passender Roboter in 2 Minuten" />
        <p class="description">
            <?php esc_html_e('Überschreibt den Title auf der Robo-Finder-Seite (Slug: robo-finder).', 'robo-finder-pro'); ?>
        </p>
        <?php
    }
    ...
    public function field_finder_meta_description()
    {
        $settings = $this->get_settings();
        ?>
        <textarea name="<?php echo esc_attr($this->settings_option); ?>[finder_meta_description]" rows="3" class="large-text"
            placeholder="Beantworte ein paar Fragen und erhalte eine klare Roboter-Empfehlung – inkl. Einsatz-Check, Features und Beratung."><?php echo esc_textarea($settings['finder_meta_description']); ?></textarea>
        <?php
    }
    ...
    public function render_robot_settings_page()
    {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e('Hier pflegst du die technischen Roboter-Details getrennt vom Editor. Der Editor bleibt für Text, Bilder & Praxisberichte.', 'robo-finder-pro'); ?>
            </p>
            ...
            <?php if ($robot && $robot->post_type === 'robo_robot'): ?>
                ...
                <p style="margin-top:4px;">
                    <a href="<?php echo esc_url(get_edit_post_link($robot_id, '')); ?>"
                        class="button"><?php esc_html_e('Beitrag/Editor öffnen', 'robo-finder-pro'); ?></a>
                    <a href="<?php echo esc_url(get_permalink($robot_id)); ?>" class="button" target="_blank"
                        rel="noopener noreferrer"><?php esc_html_e('Produktseite ansehen', 'robo-finder-pro'); ?></a>
                </p>
                ...
                <form method="post">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input type="text" id="rf_manufacturer" name="rf_manufacturer"
                                    value="<?php echo esc_attr($values['manufacturer'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="rf_price_band"><?php esc_html_e('Preis-/Segmentbeschreibung', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_price_band" name="rf_price_band"
                                    value="<?php echo esc_attr($values['price_band'] ?? ''); ?>" class="regular-text"
                                    placeholder="z. B. Premium, Mittelklasse, Einstieg" /></td>
                        </tr>
                        <tr>
                    ...
                    <table class="form-table">
                        <tr>
                            <th><label for="rf_m2h"><?php esc_html_e('Flächenleistung (m²/h, ca.)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_m2h" name="rf_m2h" value="<?php echo esc_attr($values['m2h'] ?? ''); ?>"
                                    class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_battery"><?php esc_html_e('Akkulaufzeit (Std., ca.)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_battery" name="rf_battery"
                                    value="<?php echo esc_attr($values['battery'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="rf_tank"><?php esc_html_e('Tankvolumen gesamt (Liter, ca.)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_tank" name="rf_tank"
                                    value="<?php echo esc_attr($values['tank'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label
                                    for="rf_clean_water"><?php esc_html_e('Reinwasser (Liter, ca.)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_clean_water" name="rf_clean_water"
                                    value="<?php echo esc_attr($values['clean_water'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_dirty_water"><?php esc_html_e('Abwasser (Liter, ca.)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_dirty_water" name="rf_dirty_water"
                                    value="<?php echo esc_attr($values['dirty_water'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input type="text" id="rf_dimensions" name="rf_dimensions"
                                    value="<?php echo esc_attr($values['dimensions'] ?? ''); ?>" class="regular-text"
                                    placeholder="z. B. 540 x 440 x 617 mm (L/B/H)" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_working_width"><?php esc_html_e('Arbeitsbreite', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="text" id="rf_working_width" name="rf_working_width"
                                    value="<?php echo esc_attr($values['working_width'] ?? ''); ?>" class="regular-text"
                                    placeholder="z. B. 330 – 410 mm" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_noise"><?php esc_html_e('Geräuschpegel', 'robo-finder-pro'); ?></label></th>
                            <td><input type="text" id="rf_noise" name="rf_noise"
                                    value="<?php echo esc_attr($values['noise'] ?? ''); ?>" class="regular-text"
                                    placeholder="z. B. < 65 dB" /></td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input type="text" id="rf_nav" name="rf_nav" value="<?php echo esc_attr($values['nav'] ?? ''); ?>"
                                    class="regular-text" placeholder="z. B. LiDAR + 3D-Kamera" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_product_url"><?php esc_html_e('Produkt-URL (extern)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="url" id="rf_product_url" name="rf_product_url"
                                    value="<?php echo esc_attr($values['product_url'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_video_url"><?php esc_html_e('Video-URL (optional)', 'robo-finder-pro'); ?></label>
                            </th>
                            <td><input type="url" id="rf_video_url" name="rf_video_url"
                                    value="<?php echo esc_attr($values['video_url'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th><label for="rf_forum_topic_url"><?php esc_html_e('Forum-Topic URL', 'robo-finder-pro'); ?></label>
                            </th>
                            <td>
                                <input type="url" id="rf_forum_topic_url" name="rf_forum_topic_url"
                                    value="<?php echo esc_attr($values['forum_topic_url'] ?? ''); ?>" class="regular-text"
                                    placeholder="https://robo-guru.de/community/forum/.../" />
                                <p class="description">
                                    <?php esc_html_e('Die URL zum passenden Forum-Thema (z. B. Phantas S1 Pro Topic).', 'robo-finder-pro'); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input type="text" id="rf_highlight_1" name="rf_highlight_1"
                                    value="<?php echo esc_attr($values['highlight_1'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_highlight_2"><?php esc_html_e('Highlight 2', 'robo-finder-pro'); ?></label></th>
                            <td><input type="text" id="rf_highlight_2" name="rf_highlight_2"
                                    value="<?php echo esc_attr($values['highlight_2'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="rf_highlight_3"><?php esc_html_e('Highlight 3', 'robo-finder-pro'); ?></label></th>
                            <td><input type="text" id="rf_highlight_3" name="rf_highlight_3"
                                    value="<?php echo esc_attr($values['highlight_3'] ?? ''); ?>" class="regular-text" /></td>
                        </tr>
                    </table>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <textarea id="rf_ideal_for" name="rf_ideal_for" class="large-text" rows="4"
                                    placeholder="Stichpunkte oder kurzer Text..."><?php echo esc_textarea($values['ideal_for'] ?? ''); ?></textarea>
                                <p class="description">
                                    <?php esc_html_e('Wird im Frontend als „Ideal für“ Box angezeigt.', 'robo-finder-pro'); ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <th><label for="rf_not_ideal_for"><?php esc_html_e('Nicht ideal für', 'robo-finder-pro'); ?></label>
                            </th>
                            <td>
                                <textarea id="rf_not_ideal_for" name="rf_not_ideal_for" class="large-text" rows="4"
                                    placeholder="Stichpunkte oder kurzer Text..."><?php echo esc_textarea($values['not_ideal_for'] ?? ''); ?></textarea>
                                <p class="description">
                                    <?php esc_html_e('Wird im Frontend als „Nicht ideal für“ Box angezeigt.', 'robo-finder-pro'); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <tbody>
                        <?php if (!empty($robots)): ?>
                            <?php foreach ($robots as $r):
                                ...
                                ?>
                                <tr>
                                    <td><?php echo esc_html($r->post_title); ?> <span style="color:#6b7280;">(ID
                                            <?php echo esc_html($r->ID); ?>)</span></td>
                                    <td><?php echo esc_html($man ? $man : '—'); ?></td>
                                    <td><?php echo esc_html($r->post_status); ?></td>
                                    <td><a class="button button-small"
                                            href="<?php echo esc_url($link); ?>"><?php esc_html_e('Konfigurieren', 'robo-finder-pro'); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="4"><?php esc_html_e('Noch keine Roboter vorhanden.', 'robo-finder-pro'); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    public function render_leads_page()
    {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e('Übersicht der Leads, die direkt aus dem Robo Finder generiert wurden.', 'robo-finder-pro'); ?>
            </p>
                    ...
                    <?php if (!empty($leads)): ?>
                        <?php foreach ($leads as $lead): ?>
                            <tr>
                                ...
                                <td><a href="mailto:<?php echo esc_attr($lead->email); ?>"><?php echo esc_html($lead->email); ?></a>
                                </td>
                                <td><?php echo esc_html($lead->phone); ?></td>
                                <td><?php echo esc_html(substr((string) $lead->note, 0, 80) . (strlen((string) $lead->note) > 80 ? '…' : '')); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
    ...
    public function render_scraper_page()
    {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e('Lege Roboter aus RoboPlanet-Produktseiten automatisch an (Basisdaten wie Titel, Hersteller, Abmessungen, Flächenleistung usw.).', 'robo-finder-pro'); ?>
            </p>
            ...
            <form method="post">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="url" id="rf_scraper_url" name="rf_scraper_url" class="regular-text"
                                placeholder="https://robo-planet.de/roboter/gausium-phantas/" />
                            <p class="description">
...
JS;
                ...
                <div class="rf-card">
                    ...
                    <div class="rf-topbar">
                        <div class="rf-topbar__left">
                            <span class="rf-topbar__step">Step <strong data-rf-step-n>1</strong>/<span
                                    data-rf-step-total>6</span></span>
                        </div>
                            ...
                            <div class="rf-main">
                                <div class="rf-steps">
                                    ...
                                    <div class="rf-step is-active" data-step="1">
                                        <label
                                            class="rf-label"><?php esc_html_e('Was soll der Roboter tun?', 'robo-finder-pro'); ?></label>
                                        <p class="rf-help">
                                            <?php esc_html_e('Damit wir direkt den passenden Robotertyp auswählen (Reinigung vs. Lieferung) – ohne Umwege.', 'robo-finder-pro'); ?>
                                        </p>

                                        <?php echo $this->render_tax_tiles('robo_task', 'rf_task', array(), 'radio'); ?>

                                        <div class="rf-nav">
                                            <button type="button" class="button rf-next"
                                                data-rf-next><?php esc_html_e('Weiter', 'robo-finder-pro'); ?></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rf-step" data-step="2">
                                        <label
                                            class="rf-label"><?php esc_html_e('Wo soll der Roboter eingesetzt werden?', 'robo-finder-pro'); ?></label>
                                        <p class="rf-help">
                                            <?php esc_html_e('Wo soll der Roboter fahren/arbeiten? Wähle 1–3 Bereiche, damit wir die Anforderungen realistisch einschätzen.', 'robo-finder-pro'); ?>
                                        </p>

                                        <?php echo $this->render_tax_tiles('robo_env', 'rf_env', array(), 'checkbox'); ?>

                                        <div class="rf-nav">
                                            <button type="button" class="button rf-prev"
                                                data-rf-prev><?php esc_html_e('Zurück', 'robo-finder-pro'); ?></button>
                                            <button type="button" class="button rf-next"
                                                data-rf-next><?php esc_html_e('Weiter', 'robo-finder-pro'); ?></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rf-step" data-step="3">
                                        <label
                                            class="rf-label"><?php esc_html_e('Barrierefreiheit', 'robo-finder-pro'); ?></label>
                                        <p class="rf-help">
                                            <?php esc_html_e('Hindernisse entscheiden über Sensorik, Rampenfähigkeit und die richtige Modellklasse. Je ehrlicher, desto besser die Empfehlung.', 'robo-finder-pro'); ?>
                                        </p>
                                        ...
                                        <div class="rf-terra-box">
                                            <div class="rf-terra-inline-top">
                                                ...
                                                <span
                                                    class="rf-terra-pill"><?php esc_html_e('Bitte wählen', 'robo-finder-pro'); ?></span>
                                            </div>

                                            <div class="rf-terra-cards" role="group" aria-label="Barrierefreiheit">
                                                <div class="rf-terra-card" data-key="stufen_treppen" tabindex="0" role="button"
                                                    aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Stufen / Treppen', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Gibt es Stufen oder Treppen?', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="rf-terra-card" data-key="aufzug" tabindex="0" role="button"
                                                    aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Fahrstuhl / Aufzug', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Falls Etagen: gibt es einen Aufzug/Fahrstuhl?', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="rf-terra-card" data-key="rampen_schwellen" tabindex="0"
                                                    role="button" aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Rampen / Schwellen', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Rampen, Schwellen oder Kanten?', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="rf-terra-card" data-key="enge_tueren" tabindex="0" role="button"
                                                    aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Enge Türen', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Schmale Durchgänge / Brandschutztüren?', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="rf-terra-card" data-key="tore" tabindex="0" role="button"
                                                    aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Tore / Rolltore', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Gibt es Tore oder automatische Türen im Fahrweg?', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="rf-terra-card" data-key="alles_ebenerdig" tabindex="0" role="button"
                                                    aria-pressed="false">
                                                    <div>
                                                        <p class="rf-terra-card-title">
                                                            <?php esc_html_e('Alles ebenerdig', 'robo-finder-pro'); ?>
                                                        </p>
                                                        <p class="rf-terra-card-sub">
                                                            <?php esc_html_e('Keine Stufen, keine Schwellen.', 'robo-finder-pro'); ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="rf-terra-inline-hint">
                                                <?php esc_html_e('Mehrfachauswahl möglich (außer „Alles ebenerdig“).', 'robo-finder-pro'); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="rf-nextsteps" data-rf-nextsteps>
                                            ...
                                            <div class="rf-nextsteps__note" data-rf-fehlkauf hidden>
                                                <strong>Warum wir prüfen:</strong> Bei Stufen, Toren oder Rampen unterscheiden
                                                sich Roboter stark – eine kurze Prüfung verhindert teure Fehlkäufe.
                                            </div>
                                        </div>
                                    ...
                                    <div class="rf-step" data-step="4">
                                        ...
                                        <p class="rf-help">
                                            <?php esc_html_e('Wir fragen in Stufen, weil m² meist nur ca. bekannt sind – das reicht für eine saubere Vorauswahl & ROI-Schätzung.', 'robo-finder-pro'); ?>
                                        </p>
                                        ...
                                        <div class="rf-terra-box rf-area-box">
                                            ...
                                            <div class="rf-area-steps" role="radiogroup" aria-label="Fläche in Stufen">
                                                <label class="rf-area-step">
                                                    <input type="radio" name="rf_area_bucket" value="50-500" data-mid="275"
                                                        checked>
                                                    <span>50–500&nbsp;m²</span>
                                                </label>
                                                <label class="rf-area-step">
                                                ...
                                                <label class="rf-area-step">
                                                    <input type="radio" name="rf_area_bucket" value="5000-10000"
                                                        data-mid="7500">
                                                    <span>5.000–10.000&nbsp;m²</span>
                                                </label>
                                                <label class="rf-area-step">
                                                    <input type="radio" name="rf_area_bucket" value="10000-50000"
                                                        data-mid="30000">
                                            ...
                                            <div class="rf-terra-inline-hint rf-area-hint">
                                                <?php esc_html_e('Schätzung reicht – wir nutzen den Wert für die Empfehlung.', 'robo-finder-pro'); ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="rf-step" data-step="5">
                                        ...
                                        <p class="rf-help">Gibt es Besonderheiten oder Wünsche? Optional – je genauer, desto
                                            passender wird unsere Empfehlung.</p>
                                        ...
                                        <div class="rf-notes">
                                            ...
                                            <div class="rf-tags" aria-label="Schnell-Auswahl">
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Leise im Betrieb">leise</button>
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Nachtbetrieb / außerhalb der Öffnungszeiten">Nachtbetrieb</button>
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Hohe Hygieneanforderungen (z.B. Klinik / Lebensmittel)">Hygiene</button>
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Enge Bereiche / schmale Gänge / Türen">enge
                                                    Bereiche</button>
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Viele Türen / Aufzüge / Brandschutztüren">viele
                                                    Türen</button>
                                                <button type="button" class="rf-tag"
                                                    data-rf-add-note="Service & Reaktionszeit sind kritisch">Service
                                                    wichtig</button>
                                                <button type="button" class="rf-tag rf-tag--ghost" data-rf-clear-notes>Alles
                                                    löschen</button>
                                            </div>

                                            <textarea class="rf-textarea" id="rf_notes" data-rf-notes rows="6"
                                                placeholder="z.B. Nachtreinigung, enge Gänge, Lärm, Hygiene, Aufzüge, Türen, Gästeverkehr, Servicezeiten …"></textarea>
                                            <div class="rf-counter"><span data-rf-notes-count>0</span>/400</div>
                                            <div class="rf-help rf-help--small">Tipp: Stichpunkte reichen – wir berücksichtigen
                                                das 1:1 in der Beratung.</div>

                                            <div class="rf-critical" data-rf-critical-wrap hidden>
                                                <div class="rf-critical-head">Wichtiger Hinweis zu deinem Objekt</div>
                                                <div class="rf-critical-sub">Deine Angaben deuten auf besondere Anforderungen
                                                    hin. Damit wir dir nichts Falsches empfehlen, beschreibe bitte kurz, was wir
                                                    unbedingt wissen müssen.</div>
                                                <textarea class="rf-textarea rf-textarea--critical" id="rf_critical_notes"
                                                    data-rf-critical-notes rows="4"
                                                    placeholder="z.B. Stufen ohne Aufzug, sehr enge Gänge, Nachtbetrieb, Lärmgrenzen, Aufzüge nur eingeschränkt nutzbar …"></textarea>
                                                <div class="rf-counter"><span data-rf-critical-count>0</span>/400</div>
                                                <div class="rf-validation" data-rf-critical-hint hidden>Bitte gib hier einen
                                                    kurzen Hinweis ein (mind. 15 Zeichen).</div>
                                            </div>
                                        </div>
                                        ...
                                        <p class="rf-help">Prüfe kurz deine Angaben. Wenn alles passt, kannst du jetzt das
                                            Angebot anfordern.</p>
                                        ...
                                        <div class="rf-nav rf-nav-sticky">
                                            ...
                                            <button type="button" class="button button-primary rf-next rf-to-form"
                                                data-rf-next>Angebot anfordern</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rf-step" data-step="6">
                                        <label class="rf-label"
                                            data-rf-s6-label><?php esc_html_e('Angebot anfordern', 'robo-finder-pro'); ?></label>
                                        <p class="rf-sub" data-rf-s6-sub>
                                            <?php esc_html_e('Trag deine Kontaktdaten ein – wir melden uns mit einer passenden Empfehlung.', 'robo-finder-pro'); ?>
                                        </p>
                                        ...
                                        <div class="rf-terra-final-form">
                                            <p class="rf-terra-final-title" data-rf-final-title>
                                                <?php esc_html_e('Kontakt & Angebot', 'robo-finder-pro'); ?>
                                            </p>
                                            <?php
    ...
    public function render_contact_modal()
    {
        ...
        <div id="rf-contact-modal" class="rf-modal" role="dialog" aria-modal="true"
            aria-label="<?php esc_attr_e('Kontaktformular', 'robo-finder-pro'); ?>" style="display:none">
            <div class="rf-modal-header">
                <h3 class="rf-modal-title"><?php echo esc_html($settings['contact_button_text']); ?></h3>
                <button type="button" class="rf-modal-close"
                    aria-label="<?php esc_attr_e('Modal schließen', 'robo-finder-pro'); ?>">✕</button>
            </div>
            ...
            <div id="rf-forum-inline-mount" class="rf-forum-inline" style="display:none;">
                <div class="rf-forum-inline-card">
                    ...
                    <div class="rf-forum-inline-body">
                        ...
                        <p class="rf-forum-inline-sub">
                            <?php esc_html_e('Direkt Details ansehen oder in die Diskussion springen.', 'robo-finder-pro'); ?>
                        </p>
                        <div class="rf-forum-inline-actions">
                            <a class="rf-forum-inline-btn primary"
                                href="<?php echo esc_url($url); ?>"><?php esc_html_e('Zur Detailseite', 'robo-finder-pro'); ?></a>
                            <a class="rf-forum-inline-btn"
                                href="<?php echo esc_url($forum); ?>"><?php esc_html_e('Forum öffnen', 'robo-finder-pro'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="rf-forum-box-grid">
                    ...
                    <div class="rf-forum-box-body">
                        ...
                        <div class="rf-forum-actions">
                            <a class="primary"
                                href="<?php echo esc_url($url); ?>"><?php esc_html_e('Zur Roboter-Detailseite', 'robo-finder-pro'); ?></a>
                            <a
                                href="<?php echo esc_url($forum); ?>"><?php esc_html_e('Forum-Thema öffnen', 'robo-finder-pro'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="rf-forum-card">
                ...
                <div class="rf-forum-body">
                    ...
                    <div class="rf-forum-btns">
                        <a class="rf-forum-btn"
                            href="<?php echo esc_url($forum); ?>"><?php esc_html_e('Forum', 'robo-finder-pro'); ?></a>
                        <a class="rf-forum-btn primary"
                            href="<?php echo esc_url($url); ?>"><?php esc_html_e('Details', 'robo-finder-pro'); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table" role="presentation">
                <tr>
                    ...
                    <td>
                        <textarea id="rfp_sureforms_shortcode" name="rfp_sureforms_shortcode" rows="4"
                            style="width:100%;max-width:900px;"><?php echo esc_textarea(get_option('rfp_sureforms_shortcode', '')); ?></textarea>
                        <p class="description">
                            Beispiel: <code>[sureforms id="123"]</code><br>
                            Lege im Formular Hidden-Felder an (z.B. <code>rf_env</code>, <code>rf_task</code>,
                            <code>rf_floor</code>, <code>rf_area_sqm</code>, <code>rf_tables</code>,
                            <code>rf_barriers</code>) – diese werden automatisch befüllt.
                        </p>
                    </td>
                </tr>
            </table>
