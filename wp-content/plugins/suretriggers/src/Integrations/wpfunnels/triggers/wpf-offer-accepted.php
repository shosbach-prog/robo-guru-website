...
if ( ! class_exists( 'WpfOfferAccepted' ) ) :
	...
	class WpfOfferAccepted {
		 ...
		 * @var string
		 */
		public $trigger = 'wpf_offer_accepted';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Offer Accepted', 'suretriggers' ),
				'action'        => $this->trigger,
				'common_action' => 'wpfunnels/offer_accepted',
		 ...
		 * @param string $offer_type The offer type (upsell or downsell).
		 * @since 1.0.0
		 *
		 * @return void
		 */
		public function trigger_listener( $funnel_id, $step_id, $order_id, $offer_type ) {
			$context                = [];
