...
class MC4WP_Styles_Builder_Public
{
    ...
    public function add_hooks()
    {
        ...
        add_action('wp', [ $this, 'maybe_load_preview' ], 99);
        add_action('mc4wp_load_form_stylesheets', [ $this, 'load_stylesheets' ]);
    }
    ...
    public function load_stylesheets($stylesheets)
    {
        ...
        $base_url = str_ireplace([ 'http://', 'https://' ], '//', $uploads['baseurl']);
        ...
        if (file_exists($uploads['basedir'] . $bundle_filename)) {
            ...
            wp_enqueue_style('mc4wp-form-styles-builder', $url, [], $version);
