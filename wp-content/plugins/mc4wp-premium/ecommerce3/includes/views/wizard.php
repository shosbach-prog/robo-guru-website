    ...
    <div class="mc4wp-wizard">
        ...
        <div class="mc4wp-wizard-steps-nav">
            ...
            foreach ($steps as $number => $label) {
                ...
                if ($current > $number) {
                    printf('<a href="%s">%d. %s</a>', esc_attr(add_query_arg([ 'wizard' => $number])), $number, $label);
                } else {
        ...
        <div class="mc4wp-well">
            ...
            <div class="mc4wp-wizard-step clearfix" style="display: <?php echo $current == 2 ? 'block' : 'none'; ?>">
                ...
                <p class="submit">
                    <a class="button button-primary next" href="<?php echo esc_attr(add_query_arg([ 'wizard' => 3 ])); ?>"><?php _e('Next', 'mc4wp-ecommerce'); ?></a>
                </p>
            </div>
            ...
            <div class="mc4wp-wizard-step clearfix" style="display: <?php echo $current == 3 ? 'block' : 'none'; ?>">
                ...
                <p class="submit">
                    <a class="button button-primary next" href="<?php echo esc_attr(remove_query_arg('wizard')); ?>"><?php _e('Finish', 'mc4wp-ecommerce'); ?></a>
                </p>
            </div>
