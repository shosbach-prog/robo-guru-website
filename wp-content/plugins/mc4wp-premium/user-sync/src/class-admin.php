...
class Admin
{
    ...
    public function add_hooks(): void
    {
        ...
        add_action('load-mc4wp_page_mailchimp-for-wp-user-sync', [$this, 'action_load_page'], 10, 0);
    ...
    public function action_load_page(): void
    {
        if (! mc4wp_has_active_license()) {
            mc4wp('admin.messages')->flash('You need to activate your MC4WP Premium license in order to access the User Sync settings page.', 'notice');
            wp_safe_redirect('admin.php?page=mailchimp-for-wp-other');
            exit;
        }
    }
